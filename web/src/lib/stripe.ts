...
export const CHANNEL_CATALOG: Readonly<Record<ChannelKey, ChannelCatalog>> = {
  WEBCHAT: {
    ...
    tiers: {
      ...
      ENTERPRISE: { label: "Scale",   priceId: env("STRIPE_PRICE_WEBCHAT_ENTERPRISE"), price: 599, conversationsLimit: 10000, setupFee: 0 },
    },
  ...
  WHATSAPP: {
    ...
    tiers: {
      ...
      ENTERPRISE: { label: "Scale",   priceId: env("STRIPE_PRICE_WA_ENTERPRISE"), price: 899, conversationsLimit: 10000, setupFee: 0 },
    },
  ...
  INSTAGRAM: {
    ...
    tiers: {
      ...
      ENTERPRISE: { label: "Scale",   priceId: env("STRIPE_PRICE_IG_ENTERPRISE"), price: 699, conversationsLimit: 10000, setupFee: 0 },
    },
  ...
  MESSENGER: {
    ...
    tiers: {
      ...
      ENTERPRISE: { label: "Scale",   priceId: env("STRIPE_PRICE_MSG_ENTERPRISE"), price: 699, conversationsLimit: 10000, setupFee: 0 },
    },
