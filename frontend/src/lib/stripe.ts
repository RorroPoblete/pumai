...
export const CHANNEL_CATALOG: Readonly<Record<ChannelKey, ChannelCatalog>> = {
  WEBCHAT: {
    ...
    tiers: {
      ...
      GROWTH:     { label: "Growth",     priceId: env("STRIPE_PRICE_WEBCHAT_GROWTH"),     price: 249, conversationsLimit: 2000, setupFee: 300 },
      ENTERPRISE: { label: "Enterprise", priceId: env("STRIPE_PRICE_WEBCHAT_ENTERPRISE"), price: 599, conversationsLimit: null, setupFee: 0 },
    },
  ...
  WHATSAPP: {
    ...
    tiers: {
      ...
      GROWTH:     { label: "Growth",     priceId: env("STRIPE_PRICE_WA_GROWTH"),     price: 449, conversationsLimit: 2000, setupFee: 900 },
      ENTERPRISE: { label: "Enterprise", priceId: env("STRIPE_PRICE_WA_ENTERPRISE"), price: 999, conversationsLimit: null, setupFee: 0 },
    },
  ...
  INSTAGRAM: {
    ...
    tiers: {
      ...
      ENTERPRISE: { label: "Enterprise", priceId: env("STRIPE_PRICE_IG_ENTERPRISE"), price: 799, conversationsLimit: null, setupFee: 0 },
    },
  ...
  MESSENGER: {
    ...
    free: null,
    tiers: {
      STARTER:    { label: "Starter",    priceId: env("STRIPE_PRICE_MSG_STARTER"),    price: 119, conversationsLimit: 500,  setupFee: 300 },
      GROWTH:     { label: "Growth",     priceId: env("STRIPE_PRICE_MSG_GROWTH"),     price: 329, conversationsLimit: 2000, setupFee: 600 },
      ENTERPRISE: { label: "Enterprise", priceId: env("STRIPE_PRICE_MSG_ENTERPRISE"), price: 749, conversationsLimit: null, setupFee: 0 },
    },
