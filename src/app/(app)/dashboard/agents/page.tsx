    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="gradient-btn text-white text-sm font-semibold px-5 py-2.5 rounded-xl glow-sm hover:glow-md transition-all duration-300">
            + New Agent
          </button>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 mt-4 pt-4 border-t border-[rgba(255,255,255,0.04)] opacity-0 group-hover:opacity-100 transition-opacity">
                  <button className="text-xs text-[#A1A1AA] hover:text-white transition-colors px-3 py-1.5 rounded-lg hover:bg-[rgba(255,255,255,0.04)]">
                    Edit
                  </button>
                  <button className="text-xs text-[#A1A1AA] hover:text-white transition-colors px-3 py-1.5 rounded-lg hover:bg-[rgba(255,255,255,0.04)]">
                    Test
                  ...
                  {a.status === "active" ? (
                    <button className="text-xs text-[#f59e0b] hover:text-[#fbbf24] transition-colors px-3 py-1.5 rounded-lg hover:bg-[rgba(245,158,11,0.08)]">
                      Pause
                    </button>
                  ) : (
                    <button className="text-xs text-[#22c55e] hover:text-[#4ade80] transition-colors px-3 py-1.5 rounded-lg hover:bg-[rgba(34,197,94,0.08)]">
                      Activate
                    </button>
                  )}
                </div>
